...
* "SockJS-protocol spec":http://sockjs.github.com/sockjs-protocol/sockjs-protocol-0.3.html
...
./venv/bin/python sockjs-protocol-0.3.py XhrStreaming

# Run only XhrStreaming.test_transport test.
./venv/bin/python sockjs-protocol-0.3.py XhrStreaming.test_transport
</pre>
